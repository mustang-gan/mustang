...
class ConfigurationContainer:
    class_maps = {
        ...
        'heuristicloss': ('networks.smugan_loss', 'HeuristicLoss'),
        'smuganloss': ('networks.smugan_loss', 'SMuGANLoss'),
        ...
        'gaussian_circular': ('data.gaussian_circular_toy_data_loader', 'GaussianCircularToyDataLoader'),
        'circular': ('data.circular_toy_data_loader', 'CircularToyDataLoader'),
        'grid': ('data.grid_toy_data_loader', 'GridToyDataLoader'),
        'gaussian_grid': ('data.gaussian_grid_toy_data_loader','GaussianGridToyDataLoader'),
